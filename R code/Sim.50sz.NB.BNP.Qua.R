...
Rst.50sz.NB.BNP.200sim <- list()
Rst.50sz.NB.BNP.200sim[[1]] <- eta_sim
Rst.50sz.NB.BNP.200sim[[2]] <- eta_sd
Rst.50sz.NB.BNP.200sim[[3]] <- gamma1_sim
Rst.50sz.NB.BNP.200sim[[4]] <- gamma1_sd_sim
Rst.50sz.NB.BNP.200sim[[5]] <- gamma2_sim
Rst.50sz.NB.BNP.200sim[[6]] <- gamma2_sd_sim
Rst.50sz.NB.BNP.200sim[[7]] <- rho_sim
Rst.50sz.NB.BNP.200sim[[8]] <- rho_sd_sim
Rst.50sz.NB.BNP.200sim[[9]] <- lpml_sim
Rst.50sz.NB.BNP.200sim[[10]] <- f_sim
Rst.50sz.NB.BNP.200sim[[11]] <- f_sd_sim
Rst.50sz.NB.BNP.200sim[[12]] <- W_sim
Rst.50sz.NB.BNP.200sim[[13]] <- eta_mse
Rst.50sz.NB.BNP.200sim[[14]] <- imse_sim
names(Rst.50sz.NB.BNP.200sim) <- c("eta", "eta_sd", "gamma1", "gamma1_sd", 
                                   "gamma2", "gamma2_sd",  
                                   "rho", "rho_sd", 
                                   "lpml_sim", "f_sim", "f_sd", 
                                   "W_sim", "eta mse", "imse sim")
save(Rst.50sz.NB.BNP.200sim, file = paste(dir_odfl, "Rst.50sz.NB.Qua.BNP.200sim.RData", sep = '/'))
