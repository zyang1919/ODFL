...
for(s in 1:nsim){
  ...
  X_design <- rbind(rep(1, length(Xi)), Xi, (Xi)^2)
  dx <- diff(Xi)
  nx <- length(Xi)-1
  ytrue <- 5 + (-0.01)*Xi + (-0.05)*Xi^2
...
Rst.50sz.NB.BP.100sim <- list()
Rst.50sz.NB.BP.100sim[[1]] <- eta_sim
Rst.50sz.NB.BP.100sim[[2]] <- eta_sd
Rst.50sz.NB.BP.100sim[[3]] <- gamma1_sim
Rst.50sz.NB.BP.100sim[[4]] <- gamma1_sd_sim
Rst.50sz.NB.BP.100sim[[5]] <- gamma2_sim
Rst.50sz.NB.BP.100sim[[6]] <- gamma2_sd_sim
Rst.50sz.NB.BP.100sim[[7]] <- rho_sim
Rst.50sz.NB.BP.100sim[[8]] <- rho_sd_sim
Rst.50sz.NB.BP.100sim[[9]] <- lpml_sim
Rst.50sz.NB.BP.100sim[[10]] <- theta_sim
Rst.50sz.NB.BP.100sim[[11]] <- theta_sd_sim
Rst.50sz.NB.BP.100sim[[12]] <- W_sim
Rst.50sz.NB.BP.100sim[[13]] <- eta_mse
Rst.50sz.NB.BP.100sim[[14]] <- imse_sim
names(Rst.50sz.NB.BP.100sim) <- c("eta", "eta_sd", "gamma1", "gamma1_sd", 
                                  "gamma2", "gamma2_sd", 
                                  "rho", "rho_sd", 
                                  "lpml_sim", "theta_sim", "theta_sd", 
                                  "W_sim", "eta mse", "imse sim")
save(Rst.50sz.NB.BP.100sim, file = paste(dir_odfl, "Rst.50sz.NB.BP.100sim.RData", sep = '/'))
