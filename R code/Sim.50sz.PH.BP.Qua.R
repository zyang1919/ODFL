...
Rst.50sz.PH.BP.100sim <- list()
Rst.50sz.PH.BP.100sim[[1]] <- eta_sim
Rst.50sz.PH.BP.100sim[[2]] <- eta_sd
Rst.50sz.PH.BP.100sim[[3]] <- gamma_sim
Rst.50sz.PH.BP.100sim[[4]] <- gamma_sd_sim
Rst.50sz.PH.BP.100sim[[5]] <- lambda_sim
Rst.50sz.PH.BP.100sim[[6]] <- lambda_sd_sim
Rst.50sz.PH.BP.100sim[[7]] <- rho_sim
Rst.50sz.PH.BP.100sim[[8]] <- rho_sd_sim
Rst.50sz.PH.BP.100sim[[9]] <- lpml_sim
Rst.50sz.PH.BP.100sim[[10]] <- theta_sim
Rst.50sz.PH.BP.100sim[[11]] <- theta_sd_sim
Rst.50sz.PH.BP.100sim[[12]] <- W_sim
Rst.50sz.PH.BP.100sim[[13]] <- eta_mse
Rst.50sz.PH.BP.100sim[[14]] <- imse_sim
names(Rst.50sz.PH.BP.100sim) <- c("eta", "eta_sd", "gamma", "gamma_sd", 
                                  "lambda", "lambda_sd", 
                                  "rho", "rho_sd", 
                                  "lpml_sim", "theta_sim", "theta_sd", 
                                  "W_sim", "eta mse", "imse sim")
save(Rst.50sz.PH.BP.100sim, file = paste(dir_odfl, "Rst.50sz.PH.BP.100sim.RData", sep = '/'))
