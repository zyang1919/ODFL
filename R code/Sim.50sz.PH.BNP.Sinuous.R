...
Rst.50sz.PH.BNP.Sinuous.200sim <- list()
Rst.50sz.PH.BNP.Sinuous.200sim[[1]] <- eta_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[2]] <- eta_sd
Rst.50sz.PH.BNP.Sinuous.200sim[[3]] <- gamma_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[4]] <- gamma_sd_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[5]] <- lambda_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[6]] <- lambda_sd_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[7]] <- rho_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[8]] <- rho_sd_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[9]] <- lpml_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[10]] <- f_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[11]] <- f_sd_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[12]] <- W_sim
Rst.50sz.PH.BNP.Sinuous.200sim[[13]] <- eta_mse
Rst.50sz.PH.BNP.Sinuous.200sim[[14]] <- imse_sim
names(Rst.50sz.PH.BNP.Sinuous.200sim) <- c("eta", "eta_sd", "gamma", "gamma_sd", 
                                           "lambda", "lambda_sd", 
                                           "rho", "rho_sd", 
                                           "lpml_sim", "f_sim", "f_sd", 
                                          "W_sim", "eta mse", "imse sim")
dir_rst <- "~/Desktop/Dissertation/ODFL/Simulation Revision/Result Sinuous"
save(Rst.50sz.PH.BNP.Sinuous.200sim, file = paste(dir_rst, "Rst.50sz.PH.BNP.Sinuous.200sim.RData", sep = '/'))
