...
Rst.Car.NB.BNP <- list()
Rst.Car.NB.BNP[[1]] <- W_bnp
Rst.Car.NB.BNP[[2]] <- eta_bnp
Rst.Car.NB.BNP[[3]] <- sd(etatt)
Rst.Car.NB.BNP[[4]] <- gamma2
Rst.Car.NB.BNP[[5]] <- sd(gamma2tt)
Rst.Car.NB.BNP[[6]] <- mean(rhott)
Rst.Car.NB.BNP[[7]] <- sd(rhott)
Rst.Car.NB.BNP[[8]] <- f_bnp
Rst.Car.NB.BNP[[9]] <- apply(bettt, 2, mean)
Rst.Car.NB.BNP[[10]] <- apply(bettt, 2, sd)
Rst.Car.NB.BNP[[11]] <- lpml
names(Rst.Car.NB.BNP) <- c("mean of W bnp", "eta hat", "eta sd", 
                          "gamma2 hat", "sd gamma2", "rho hat", 
                          "sd rho", "f hat", 
                          "beta hat", "beta sd", "lpml")

save(Rst.Car.NB.BNP, file = paste(dir_car, "Rst.Car.NB.BNP.RData", sep = '/'))
